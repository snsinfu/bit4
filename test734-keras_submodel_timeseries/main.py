...
def main():
    ...
    # Model
    transform = GatedDense(1)

    inputs = L.Input((window_size, input_dim))
    net = transform(inputs)
    ...
    model.fit_generator(train_data, epochs=10, verbose=2)

    # Use the transform submodel -> ERROR! Keras does not support this!
