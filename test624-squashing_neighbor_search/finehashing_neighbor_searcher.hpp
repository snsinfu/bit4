#ifndef INCLUDED_FINEHASHING_NEIGHBOR_SEARCHER_HPP
#define INCLUDED_FINEHASHING_NEIGHBOR_SEARCHER_HPP
...
namespace md
{
    ...
    public:
        ...
        finehashing_neighbor_searcher(md::scalar dcut, md::index bins)
