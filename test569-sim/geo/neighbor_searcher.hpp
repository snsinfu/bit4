// neighbor_searcher - efficient neighbor search plugin for geo.hpp

// Copyright snsinfu 2018.
// Distributed under the Boost Software License, Version 1.0. (See accompanying
// file LICENSE.txt or copy at http://www.boost.org/LICENSE_1_0.txt)

#ifndef INCLUDED_NEIGHBOR_SEARCHER_HPP
#define INCLUDED_NEIGHBOR_SEARCHER_HPP
...
namespace geo
{
    ...
    public:
        ...
        //
        // The optimal number of bins depends on the actual distribution of points. A rule-of-thumb
        // number for a dense system is the number of points divided by 20.
    ...
    private:
        ...
        // linear_hash returns the index into the hash table bins_ for given three dimensional bin
        // index (x,y,z).
