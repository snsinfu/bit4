...
void latent_dirichlet_allocation(
    int n_docs, int n_words, int n_topics, const double word_freq[n_docs][n_words]
);
...
int main(void) {
    ...
    latent_dirichlet_allocation(n_docs, n_words, n_topics, word_freq);
...
// Fit LDA to given corpus and print latent distributions.
void latent_dirichlet_allocation(
    int n_docs, int n_words, int n_topics, const double word_freq[n_docs][n_words]
) {
